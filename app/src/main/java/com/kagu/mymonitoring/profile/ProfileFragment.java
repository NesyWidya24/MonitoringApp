...
public class ProfileFragment extends Fragment {
    ...
    private TextView uName, uEmail, uProject, startDateTv, endDateTv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startDateTv = view.findViewById(R.id.startDate);
        endDateTv = view.findViewById(R.id.endDate);

        progressDialog = new ProgressDialog(getActivity());
        TextView btnExit = view.findViewById(R.id.btnExit);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    String startDate = "" + ds.child("startDate").getValue();
                    String endDate = "" + ds.child("endDate").getValue();
...
//        editText.setHint("Enter " + key);
        //get data
        Query queryET = FirebaseDatabase.getInstance().getReference("Users").orderByChild("email").equalTo(firebaseUser.getEmail());
        queryET.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    String username = "" + ds.child("fullname").getValue();
