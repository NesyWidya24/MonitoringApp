...
public class AddProjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraPerms = new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE};
        ...
        if (isUpdate.equals("editProject")) {
            titleForm.setText("Update Data Project");
            submit.setText(R.string.update_data);
            loadProjectData(editProjectId);
        } else {
            titleForm.setText("Add Data Project");
        ...
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Add data Project...");
        ...
        submit.setOnClickListener(view -> {
            ...
            if (isUpdate.equals("editProject")) {
                if (TextUtils.isEmpty(projectName)) {
                    edProjectName.setError("Field are required");
                    Toast.makeText(AddProjectActivity.this, "Enter Project Name...", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(clientName)) {
                    edClientName.setError("Field are required");
                    Toast.makeText(AddProjectActivity.this, "Enter Client Name...", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(projectDesc)) {
                    edProjectDesc.setError("Field are required");
                    Toast.makeText(AddProjectActivity.this, "Enter Project Description...", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(namePic)) {
                    edProjectDesc.setError("Field are required");
                    Toast.makeText(AddProjectActivity.this, "Enter Name PIC...", Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (editImg.equals("noImg")) {
                        Glide.with(getApplicationContext()).load(R.drawable.ic_no_img).into(imgProjects);
                    } else {
                    ...
                    if (uriTask.isSuccessful()) {
                        ...
                        reference.child(editProjectId).updateChildren(hashMap)
                                .addOnSuccessListener(aVoid1 -> {
                                    ...
                                    Toast.makeText(AddProjectActivity.this, "Data Project Updated", Toast.LENGTH_SHORT).show();
                                    finish();
                    ...
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        if (uriTask.isSuccessful()) {
                            ...
                            ref.child(timestamp).setValue(hashMap)
                                    .addOnSuccessListener(aVoid -> {
                                        progressDialog.dismiss();
                                        Toast.makeText(AddProjectActivity.this, "Data Project Success Added", Toast.LENGTH_SHORT).show();
